...
return [
    ...
    'schemas' => [
        'default' => [
            ...
            'mutation' => [
                'createTicket' => App\GraphQL\Mutations\CreateTicketMutation::class,
                'updateTicket' => App\GraphQL\Mutations\UpdateTicketMutation::class,
                'deleteTicket' => App\GraphQL\Mutations\DeleteTicketMutation::class,
            ],
